...
typedef Process = {
	...
	**/
	...
	@:overload(function(event:String, listener:RefuseHandledListener):Process { })
	@:overload(function(event:String, listener:UncaughtExceptionListener):Process { })
	@:overload(function(event:String, listener:UncaughtExceptionListener):Process { })
	@:overload(function(event:String, listener:UnhandledRefuseListener):Process { })
	...
	**/
	...
	@:overload(function(event:String):Array<RefuseHandledListener> { })
	@:overload(function(event:String):Array<UncaughtExceptionListener> { })
	@:overload(function(event:String):Array<UncaughtExceptionListener> { })
	@:overload(function(event:String):Array<UnhandledRefuseListener> { })
