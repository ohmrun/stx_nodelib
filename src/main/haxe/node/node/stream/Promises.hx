...
@:jsRequire("stream/promises") @valueModuleOnly extern class Promises {
	static function finished(stream:ts.AnyOf3<global.nodejs.WritableStream, global.nodejs.ReadableStream, global.nodejs.ReadWriteStream>, ?options:FinishedOptions):js.lib.Promise<Void>;
	...
	@:overload(function(streams:haxe.ds.ReadOnlyArray<ts.AnyOf3<global.nodejs.WritableStream, global.nodejs.ReadableStream, global.nodejs.ReadWriteStream>>, ?options:PipelineOptions):js.lib.Promise<Void> { })
