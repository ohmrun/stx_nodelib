...
@:jsRequire("assert") @valueModuleOnly extern class Assert {
	...
	**/
	@:overload(function(block:ts.AnyOf2<() -> js.lib.Promise<Any>, js.lib.Promise<Any>>, error:node.assert.AssertPredicate, ?message:ts.AnyOf2<String, js.lib.Error>):js.lib.Promise<Void> { })
	static function rejects(block:ts.AnyOf2<js.lib.Promise<Any>, () -> js.lib.Promise<Any>>, ?message:ts.AnyOf2<String, js.lib.Error>):js.lib.Promise<Void>;
	/**
		Awaits the `asyncFn` promise or, if `asyncFn` is a function, immediately
		calls the function and awaits the returned promise to complete. It will then
	...
	**/
	@:overload(function(block:ts.AnyOf2<js.lib.Promise<Any>, () -> js.lib.Promise<Any>>, error:node.assert.AssertPredicate, ?message:ts.AnyOf2<String, js.lib.Error>):js.lib.Promise<Void> { })
	static function doesNotReject(block:ts.AnyOf2<js.lib.Promise<Any>, () -> js.lib.Promise<Any>>, ?message:ts.AnyOf2<String, js.lib.Error>):js.lib.Promise<Void>;
	/**
