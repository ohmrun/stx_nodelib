...
typedef ReadLineOptions = {
	...
	@:optional
	dynamic function completer(line:String, callback:ts.AnyOf3<() -> Void, (err:js.lib.Error) -> Void, (err:js.lib.Error, result:CompleterResult) -> Void>):ts.AnyOf2<Void, CompleterResult>;
	@:optional
	var terminal : Bool;
	/**
