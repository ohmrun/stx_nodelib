...
@:jsRequire("fs/promises") @valueModuleOnly extern class Promises {
	...
	**/
	...
	/**
		...
		```
	**/
	static function copyFile(src:PathLike, dest:PathLike, ?mode:Float):js.lib.Promise<Void>;
	/**
		Opens a `FileHandle`.
	...
	**/
	static function lutimes(path:PathLike, atime:TimeLike, mtime:TimeLike):js.lib.Promise<Void>;
	/**
	...
	**/
	static function utimes(path:PathLike, atime:TimeLike, mtime:TimeLike):js.lib.Promise<Void>;
	/**
	...
	**/
	static function appendFile(path:ts.AnyOf4<String, node.buffer.Buffer, node.url.URL, node.fs.promises.FileHandle>, data:ts.AnyOf2<String, js.lib.Uint8Array>, ?options:ts.AnyOf2<String, ObjectEncodingOptions & node.fs.promises.FlagAndOpenMode>):js.lib.Promise<Void>;
	/**
	...
	**/
	static function cp(source:String, destination:String, ?opts:CopyOptions):js.lib.Promise<Void>;
}