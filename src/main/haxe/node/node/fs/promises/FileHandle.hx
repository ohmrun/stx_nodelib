...
typedef FileHandle = {
	...
	**/
	function appendFile(data:ts.AnyOf2<String, js.lib.Uint8Array>, ?options:ts.AnyOf2<String, node.fs.ObjectEncodingOptions & FlagAndOpenMode>):js.lib.Promise<Void>;
	/**
	...
	**/
	function utimes(atime:node.fs.TimeLike, mtime:node.fs.TimeLike):js.lib.Promise<Void>;
	/**
	...
	**/
	function writeFile(data:ts.AnyOf2<String, js.lib.Uint8Array>, ?options:ts.AnyOf2<String, node.fs.ObjectEncodingOptions & FlagAndOpenMode & node.events.eventemitter.Abortable>):js.lib.Promise<Void>;
	/**
