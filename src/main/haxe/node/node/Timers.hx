...
@:jsRequire("timers") @valueModuleOnly extern class Timers {
	...
	@:overload(function(callback:(args:Void) -> Void, ?ms:Float):global.nodejs.Timeout { })
	...
	@:overload(function(callback:(args:Void) -> Void, ?ms:Float):global.nodejs.Timer { })
	...
	@:overload(function(callback:(args:Void) -> Void):global.nodejs.Immediate { })
