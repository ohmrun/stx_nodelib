...
@:jsRequire("buffer", "Buffer") extern class Buffer {
	...
	**/
	...
	static function from(arrayBuffer:global.WithImplicitCoercion<ts.AnyOf2<js.lib.ArrayBuffer, js.lib.SharedArrayBuffer>>, ?byteOffset:Float, ?length:Float):global.Buffer;
	/**
		Creates a new Buffer using the passed {data}
	**/
