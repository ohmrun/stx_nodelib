...
@:jsRequire("child_process", "exec") @valueModuleOnly extern class Exec {
	...
	@:overload(function(command:String, options:{ var encoding : global.BufferEncoding; } & ExecOptions, ?callback:(error:Null<ExecException>, stdout:ts.AnyOf2<String, global.Buffer>, stderr:ts.AnyOf2<String, global.Buffer>) -> Void):ChildProcess { })
	...
	@:overload(function(command:String, options:Null<node.fs.BaseEncodingOptions & ExecOptions>, ?callback:(error:Null<ExecException>, stdout:ts.AnyOf2<String, global.Buffer>, stderr:ts.AnyOf2<String, global.Buffer>) -> Void):ChildProcess { })
	@:selfCall
