...
typedef ServerSessionOptions = {
	...
	var Http1IncomingMessage : {
		...
		**/
		...
		@:overload(function(emitter:ServerSessionOptions, event:String):js.lib.Promise<Array<Dynamic>> { })
		function once(emitter:ServerSessionOptions, event:ts.AnyOf2<String, js.lib.Symbol>):js.lib.Promise<Array<Dynamic>>;
